...
'view.paths','view.compiled','images.default','app.name','app.env',
...
'app.aliases.Http','app.aliases.Image','app.aliases.Js','app.aliases.Lang','app.aliases.Log',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.cloudinary.driver','filesystems.disks.cloudinary.key','filesystems.disks.cloudinary.secret',
'filesystems.disks.cloudinary.cloud_name','filesystems.disks.cloudinary.download_url','filesystems.disks.cloudinary.upload_url','filesystems.links./private/var/www/claritor/services/public/storage','jwt.secret',
...
'scramble.api_path','scramble.api_domain','scramble.export_path','scramble.cache.key','scramble.cache.store',
'scramble.info.version','scramble.info.description','scramble.ui.title','scramble.ui.theme','scramble.ui.hide_try_it',
'scramble.ui.hide_schemas','scramble.ui.logo','scramble.ui.try_it_credentials_policy','scramble.ui.layout','scramble.renderer',
'scramble.renderers.elements.view','scramble.renderers.elements.theme','scramble.renderers.elements.hideTryIt','scramble.renderers.elements.hideSchemas','scramble.renderers.elements.logo',
'scramble.renderers.elements.tryItCredentialsPolicy','scramble.renderers.elements.layout','scramble.renderers.elements.router','scramble.renderers.scalar.view','scramble.renderers.scalar.cdn',
'scramble.renderers.scalar.theme','scramble.renderers.scalar.proxyUrl','scramble.renderers.scalar.darkMode','scramble.renderers.scalar.showDeveloperTools','scramble.renderers.scalar.agent.disabled',
'scramble.renderers.scalar.credentials','scramble.servers','scramble.enum_cases_description_strategy','scramble.enum_cases_names_strategy','scramble.flatten_deep_query_parameters',
'scramble.middleware','scramble.extensions','scramble.security_strategy','services.postmark.key','services.resend.key',
...
'services.via_cep.url','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','session.serialization','session.refresh_token_domain','session.refresh_token_name_intranet',
'boost.enabled','boost.browser_logs_watcher','boost.rules.enabled','boost.executable_paths.php','boost.executable_paths.composer',
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','boost.executable_paths.current_directory','boost.browser_log_levels','mcp.redirect_domains',
...
'pagination::simple-bootstrap-4','pagination::simple-bootstrap-5','pagination::simple-tailwind','pagination::tailwind','scramble::docs',
'scramble::scalar',);
...
'validation.ascii','validation.base64','validation.before','validation.before_or_equal','validation.between.array',
