...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.api_token.driver' => 'string',
            'auth.guards.api_token.provider' => 'string',
            'auth.providers.users.driver' => 'string',
            'auth.providers.users.model' => 'string',
            'auth.providers.api_token_users.driver' => 'string',
            'auth.providers.api_token_users.model' => 'string',
            'auth.providers.api_token_users.table' => 'string',
            ...
            'auth.passwords.api_token_users.provider' => 'string',
            'auth.passwords.api_token_users.table' => 'string',
            'auth.passwords.api_token_users.expire' => 'integer',
            ...
            'filesystems.disks.cloudinary.driver' => 'string',
            'filesystems.disks.cloudinary.key' => 'string',
            'filesystems.disks.cloudinary.secret' => 'string',
            'filesystems.disks.cloudinary.cloud_name' => 'string',
            'filesystems.disks.cloudinary.download_url' => 'string',
            'filesystems.disks.cloudinary.upload_url' => 'string',
            'filesystems.links./private/var/www/claritor/services/public/storage' => 'string',
            'jwt.secret' => 'string',
            ...
            'scramble.cache.key' => 'string',
            'scramble.cache.store' => 'string',
            ...
            'scramble.security_strategy' => 'NULL',
            ...
            'session.refresh_token_domain' => 'NULL',
            'session.refresh_token_name_intranet' => 'NULL',
...
'auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider','auth.guards.api_token.driver','auth.guards.api_token.provider',
'auth.providers.users.driver','auth.providers.users.model','auth.providers.api_token_users.driver','auth.providers.api_token_users.model','auth.providers.api_token_users.table',
'auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.api_token_users.provider',
'auth.passwords.api_token_users.table','auth.passwords.api_token_users.expire','auth.password_timeout','cache.default','cache.stores.array.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.cloudinary.driver','filesystems.disks.cloudinary.key',
'filesystems.disks.cloudinary.secret','filesystems.disks.cloudinary.cloud_name','filesystems.disks.cloudinary.download_url','filesystems.disks.cloudinary.upload_url','filesystems.links./private/var/www/claritor/services/public/storage',
...
'queue.failed.table','scramble.api_path','scramble.api_domain','scramble.export_path','scramble.cache.key',
'scramble.cache.store','scramble.info.version','scramble.info.description','scramble.ui.title','scramble.ui.theme',
...
'scramble.renderer','scramble.renderers.elements.view','scramble.renderers.elements.theme','scramble.renderers.elements.hideTryIt','scramble.renderers.elements.hideSchemas',
'scramble.renderers.elements.logo','scramble.renderers.elements.tryItCredentialsPolicy','scramble.renderers.elements.layout','scramble.renderers.elements.router','scramble.renderers.scalar.view',
'scramble.renderers.scalar.cdn','scramble.renderers.scalar.theme','scramble.renderers.scalar.proxyUrl','scramble.renderers.scalar.darkMode','scramble.renderers.scalar.showDeveloperTools',
'scramble.renderers.scalar.agent.disabled','scramble.renderers.scalar.credentials','scramble.servers','scramble.enum_cases_description_strategy','scramble.enum_cases_names_strategy',
'scramble.flatten_deep_query_parameters','scramble.middleware','scramble.extensions','scramble.security_strategy','services.postmark.key',
...
'services.slack.notifications.channel','services.via_cep.url','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','session.refresh_token_domain',
'session.refresh_token_name_intranet','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php','boost.executable_paths.composer',
...
'mcp.authorization_server','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'signed','throttle','verified','api.token',);
        registerArgumentsSet('routes', 
'boost.browser-logs',
'storage.local','storage.local.upload','scramble.docs.ui','scramble.docs.document',);
        registerArgumentsSet('views', 
'mail.email-change','mail.password-reset','mail.verify-code','welcome','laravel-exceptions-renderer::components.badge',
...
'pagination::simple-tailwind','pagination::tailwind','scramble::docs','scramble::scalar',);
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','SERVER_PORT',
...
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','JWT_SECRET',
'JWT_TTL','CLOUDINARY_API_KEY','CLOUDINARY_API_SECRET','CLOUDINARY_CLOUD_NAME','CLOUDINARY_DOWNLOAD_URL',
'CLOUDINARY_UPLOAD_URL','VIA_CEP_URL','VITE_APP_NAME',);
